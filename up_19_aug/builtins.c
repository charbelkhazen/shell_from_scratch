...
/*   Updated: 2025/08/19 18:04:19 by chkhazen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	environment(char **args, char **env)
{
	int j = 0;
	if (args[1])
	{
...
void export_builtin(char **args, char **envp)
{
	char *var_value;
	char *var_name;
	char *new_env_var;
...
void	unset_builtin(char **args, char **env)
{
	int i;
	int j;
